...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head><script type="text/javascript">var NREUMQ=NREUMQ||[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
    <title>GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs | Source/SVN | Assembla</title>
...
<input class="main-search" id="q" name="q" onfocus="this.value == 'Search this space' ? this.value = '' : true" size="15" type="text" value="Search this space" />
  ...
  <h1 class="icon-breadcrumb-path"><a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes?rev=11" class="root">root</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper?rev=11">GmailHelper</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests?rev=11">GmailHelper.Ms.Tests</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/ImportTests?rev=11">ImportTests</a>/<span>DateTimeParserTest.cs</span><span>    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
    ...
    <param NAME="FlashVars" value="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs/" />
    ...
    <embed src="/clippy.swf"
           ...
           FlashVars="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs/"
           bgcolor="#FFFFFF"
           wmode="transparent"
    />
    </object>
...
<div class="commit-infobox">
  <div class="commit-options">
    <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/logs/GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs?rev=11" class="revision-log" rel="nofollow">Revision log</a>
      <div style="margin-right: 10px;" class="small-icon-button">
        <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/live/11/GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs" class="view-icon" rel="nofollow">View as a web page</a>
      </div>

        <div style="margin-right: 10px;" class="small-icon-button">
    <a class="download-icon" href="#" onclick="nobotGoto('!/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/ImportTests/DateTimeParserTest.cs?_format=raw&amp;rev=11'); return false;">Download</a>
  </div>
...
<a href="#ln147" class="block" id="ln147">147</a></pre></th>
...
namespace GmailHelper.Ms.Tests.ImportTests
{
    /// &lt;summary&gt;
    ...
    public class DateTimeParserTest
    {
        ...
        [TestMethod()]
        //[Ignore]
        public void CheckDatesFromDatabse()
        {

            GmailHelperLinqDataContext dc = new GmailHelperLinqDataContext();
            var dateTimeProblems = dc.Errors.Where(x =&gt; x.CallsStack.Contains(&quot;ConvertWithTimezone&quot;));
            foreach (Error error in dateTimeProblems)
            {
                try
                {
                    var result = DateTimeParser.ConvertWithTimezone(error.Context);
                    Assert.IsTrue(result.Year &gt; 2000, &quot;must be after 2000&quot;);
                    Assert.IsTrue(result.Year &lt; 2010, &quot;must be before 2010&quot;);
                }
                catch (Exception)
                {
                    Console.WriteLine(&quot;can not parse :&quot; + error.Context);
                    //throw;
                }
            }
        ...
        /// &lt;summary&gt;
        ///A test for ConvertWithTimezone
        ///&lt;/summary&gt;
        [TestMethod()]
        public void ConvertWithTimezoneTest()
        {
            string StrDate = &quot;28 Jun 04 12:37 W. Europe Daylight Time&quot;; // TODO: Initialize to an appropriate value
            var actual = DateTimeParser.ConvertWithTimezone(StrDate);
            Assert.AreEqual(actual.Year, 2004);
        ...
        [TestMethod()]
        public void ConvertWithTimezoneTest3()
        {
            string StrDate = &quot;Thu, 18 Nov 04 09:16:04 Westeuropäische Normalzeit&quot;; // TODO: Initialize to an appropriate value
            var actual = DateTimeParser.ConvertWithTimezone(StrDate);
            Assert.AreEqual(actual.Year, 2004);
        ...
        [TestMethod()]
        public void ConvertWithTimezoneTest2()
        {

            string StrDate = &quot;28 Jun 04 &quot;;// &quot;1237&quot;;// &quot; W. Europe Daylight Time&quot;; // TODO: Initialize to an appropriate value
            var actual = DateTimeParser.ConvertWithTimezone(StrDate);
            Assert.AreEqual(actual.Year, 2004);
            //no exception it works :)
        }
        ...
        [TestMethod()]
        public void ConvertWithTimezoneTest4()
        {
            string StrDate = &quot;Tue, 19 Dec 2006 18:27:19 GMT-07:00&quot;; // TODO: Initialize to an appropriate value
            var actual = DateTimeParser.ConvertWithTimezone(StrDate);
            Assert.AreEqual(actual.Year, 2006);

            //no exception it works :)
        }

        [TestMethod()]
        public void ConvertWithTimezoneTest5()
        {
            string StrDate = &quot;Thu, 18 Oct 2007 14:28:06 GMT-0700&quot;; // TODO: Initialize to an appropriate value
            var actual = DateTimeParser.ConvertWithTimezone(StrDate);
            Assert.AreEqual(actual.Year, 2007);
