...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head><script type="text/javascript">var NREUMQ=NREUMQ||[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
    <title>GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs | Source/SVN | Assembla</title>
...
<input class="main-search" id="q" name="q" onfocus="this.value == 'Search this space' ? this.value = '' : true" size="15" type="text" value="Search this space" />
  ...
  <h1 class="icon-breadcrumb-path"><a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes?rev=11" class="root">root</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper?rev=11">GmailHelper</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests?rev=11">GmailHelper.Ms.Tests</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/ImportTests?rev=11">ImportTests</a>/<span>WordParserTest.cs</span><span>    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
    ...
    <param NAME="FlashVars" value="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs/" />
    ...
    <embed src="/clippy.swf"
           ...
           FlashVars="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs/"
           bgcolor="#FFFFFF"
           wmode="transparent"
    />
    </object>
...
<div class="commit-infobox">
  <div class="commit-options">
    <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/logs/GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs?rev=11" class="revision-log" rel="nofollow">Revision log</a>
      <div style="margin-right: 10px;" class="small-icon-button">
        <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/live/11/GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs" class="view-icon" rel="nofollow">View as a web page</a>
      </div>

        <div style="margin-right: 10px;" class="small-icon-button">
    <a class="download-icon" href="#" onclick="nobotGoto('!/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/ImportTests/WordParserTest.cs?_format=raw&amp;rev=11'); return false;">Download</a>
  </div>
...
<a href="#ln116" class="block" id="ln116">116</a></pre></th>
            <td><pre class="prettyprint lang-cs">﻿using GmailHelper.ImapReader;
...
namespace GmailHelper.Ms.Tests
{
    ...
    /// &lt;summary&gt;
    ///This is a test class for WordParserTest and is intended
    ///to contain all WordParserTest Unit Tests
    ///&lt;/summary&gt;
    [TestClass()]
    public class WordParserTest
    {
        ...
        [TestMethod()]
        public void can_get_word_stats()
        {
            string subject = &quot;please please call&quot;; // TODO: Initialize to an appropriate value
            string body = &quot;call today mother mother&quot;; // TODO: Initialize to an appropriate value
            WordParser target = new WordParser(subject, body); // TODO: Initialize to an appropriate value

            var actual = target.WordStatistics();
            var pleaseFreq = new WordFreq() {SubjectFreq = 2, BodyFreq = 0};
            Assert.AreEqual(actual[&quot;please&quot;], pleaseFreq);
            var callFreq = new WordFreq() { SubjectFreq = 1, BodyFreq = 1 };
            Assert.AreEqual(actual[&quot;call&quot;], callFreq);
            var motherFreq = new WordFreq() {SubjectFreq = 0, BodyFreq = 2};
            Assert.AreEqual(actual[&quot;mother&quot;], motherFreq);
            

        }

        /// &lt;summary&gt;
        ///A test for ParseText
        ///&lt;/summary&gt;
        [TestMethod()]
        public void can_parse_text()
        {
            ...
            var actual = target.ParseText(&quot;please (Visit) viSIt  grandmother!&quot;);
            Assert.AreEqual(actual.Count, 3);
            Assert.AreEqual(actual[&quot;visit&quot;], 2);
            Assert.AreEqual(actual[&quot;please&quot;], 1);
            Assert.AreEqual(actual[&quot;grandmother&quot;], 1);


        }

        [TestMethod()]
        public void can_parse_text_remove_short_words()
        {
            string subject = string.Empty; // TODO: Initialize to an appropriate value
            string body = string.Empty; // TODO: Initialize to an appropriate value
            WordParser target = new WordParser(subject, body); // TODO: Initialize to an appropriate value

            var actual = target.ParseText(&quot;please (Visit) viSIt  grandmother! , re: fwd&quot;);
            Assert.AreEqual(actual.Count, 3);
        }
...
NREUMQ.push(["nrfj","beacon-1.newrelic.com","9dfe439095",8763,"Il9dRhNbCVtVQhgXQgBTVkFOWgpTVUMYF1oORw==",0.0,73,new Date().getTime(),"","","","",""])</script></body>
</html>
