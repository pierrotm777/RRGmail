...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head><script type="text/javascript">var NREUMQ=NREUMQ||[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
    <title>GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs | Source/SVN | Assembla</title>
...
<input class="main-search" id="q" name="q" onfocus="this.value == 'Search this space' ? this.value = '' : true" size="15" type="text" value="Search this space" />
  ...
  <h1 class="icon-breadcrumb-path"><a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes?rev=11" class="root">root</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper?rev=11">GmailHelper</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests?rev=11">GmailHelper.Ms.Tests</a>/<a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/Database?rev=11">Database</a>/<span>AutoCompleteResutsTest.cs</span><span>    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
    ...
    <param NAME="FlashVars" value="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs/" />
    ...
    <embed src="/clippy.swf"
           ...
           FlashVars="text=http://subversion.assembla.com/svn/bniEmC9p0r3P96eJe5aVNr/GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs/"
           bgcolor="#FFFFFF"
           wmode="transparent"
    />
    </object>
...
<div class="commit-infobox">
  <div class="commit-options">
    <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/logs/GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs?rev=11" class="revision-log" rel="nofollow">Revision log</a>
      <div style="margin-right: 10px;" class="small-icon-button">
        <a href="/code/bniEmC9p0r3P96eJe5aVNr/subversion/node/live/11/GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs" class="view-icon" rel="nofollow">View as a web page</a>
      </div>

        <div style="margin-right: 10px;" class="small-icon-button">
    <a class="download-icon" href="#" onclick="nobotGoto('!/code/bniEmC9p0r3P96eJe5aVNr/subversion/nodes/GmailHelper/GmailHelper.Ms.Tests/Database/AutoCompleteResutsTest.cs?_format=raw&amp;rev=11'); return false;">Download</a>
  </div>
...
<a href="#ln122" class="block" id="ln122">122</a></pre></th>
            <td><pre class="prettyprint lang-cs">﻿using GmailHelper.Data.Linq;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System.Collections.Generic;

namespace GmailHelper.Ms.Tests.Database
{
    /// &lt;summary&gt;
    ///This is a test class for AutoCompleteResutsTest and is intended
    ///to contain all AutoCompleteResutsTest Unit Tests
    ///&lt;/summary&gt;
    [TestClass()]
    public class AutoCompleteResutsTest
    {
        ...
        {
            target= new AutoCompleteResuts();
         
        }

        private AutoCompleteResuts target;
        ...
        ///&lt;/summary&gt;
        [TestMethod()]
        public void GetResultsTestSingleWord()
        {
           
            var actual = target.GetResults(&quot;alm&quot;, 10);
            Assert.IsTrue(actual.Count&gt;0);
            
        }

        [TestMethod()]
        public void GetResultsTestEmptyWord()
        {

            var actual = target.GetResults(&quot;&quot;, 10);
            Assert.IsTrue(actual.Count &gt; 0);

        }

        [TestMethod()]
        public void GetResultsTestTwoWords()
        {

            var actual = target.GetResults(&quot;almir heute&quot;, 10);
            Assert.IsTrue(actual.Count &gt; 0);
        }

        [TestMethod()]
        public void GetResultsSingleWordAndEmpty()
        {

            var actual = target.GetResults(&quot;almir &quot;, 10);
            Assert.IsTrue(actual.Count &gt; 0);
        }

        [TestMethod()]
        public void GetResultsSingleWordAndEmpty1()
        {

            var actual = target.GetResults(&quot;tanja &quot;, 10);
            Assert.IsTrue(actual.Count &gt; 0);
        }
        [TestMethod()]
        public void GetResultsSingleWordAndEmpty2()
        {

            var actual = target.GetResults(&quot;NONEXISTINGEVERE78912345 &quot;, 10);
            Assert.IsTrue(actual.Count ==0);
        }
